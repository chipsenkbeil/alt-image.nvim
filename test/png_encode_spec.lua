...
describe("_core.png.encode", function()
    it("round-trips a 2x2 RGBA image", function()
        local rgba = string.char(255, 0, 0, 255, 0, 255, 0, 255, 0, 0, 255, 255, 255, 255, 255, 255)
    ...
    it("produces compressed output when libz is available", function()
        ...
        if png_encode.has_libz() then
            ...
            assert.is_true(#encoded < raw_size / 10, "expected significant compression; got " .. #encoded .. " bytes")
        else
