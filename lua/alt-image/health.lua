...
local function tooling(h)
    ...
    if magick then
        ...
        h.info("ImageMagick: not found " .. "(set vim.g.alt_image.magick or install magick/convert)")
    end
    ...
    if libsixel then
        ...
        h.info("libsixel: not found " .. "(set vim.g.alt_image.img2sixel or install)")
    end
